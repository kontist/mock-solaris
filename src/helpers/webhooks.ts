...
const verificationSecret = {
  ...
  [CardWebhookEvent.CARD_AUTHORIZATION_RESOLUTION]: process.env.SOLARIS_CARD_AUTHORIZATION_RESOLUTION_WEBHOOK_SECRET,
  [CardWebhookEvent.CARD_AUTHORIZATION_DECLINE]: process.env.SOLARIS_CARD_AUTHORIZATION_DECLINE_WEBHOOK_SECRET,
  [CardWebhokEvent.CARD_FRAUD_CASE_PENDING]: process.env.SOLARIS_CARD_FRAUD_CASE_PENDING_WEBHOOK_SECRET,
  [CardWebhokEvent.CARD_FRAUD_CASE_TIMEOUT]: process.env.SOLARIS_CARD_FRAUD_CASE_TIMEOUT_WEBHOOK_SECRET,
  [CardWebhokEvent.CARD_LIFECYCLE_EVENT]: process.env.SOLARIS_CARD_LIFECYCLE_EVENT_WEBHOOK_SECRET,
  [CardWebhokEvent.CARD_TOKEN_LIFECYCLE]: process.env.SOLARIS_CARD_TOKEN_LIFECYCLE_WEBHOOK_SECRET,
  ...
  [TransactionWebhookEvent.SEPA_TIMED_ORDER]: process.env.SOLARIS_SEPA_TIMED_ORDER_WEBHOOK_SECRET ,
  [TransactionWebhookEvent.SEPA_DIRECT_DEBIT_RETURN]: process.env.SOLARIS_SEPA_DIRECT_DEBIT_RETURN_WEBHOOK_SECRET ,
