export const generateToken = async (req, res) => {
  ...
  if (authHeader) {
    ...
    isValidRequestUsingBasicAuth = (
      ...
      [process.env.SOLARIS_CLIENT_ID, process.env.SOLARIS_KONTIST_ACCOUNT_CLIENT_ID].includes(user) &&
      [process.env.SOLARIS_CLIENT_SECRET, process.env.SOLARIS_KONTIST_ACCOUNT_CLIENT_SECRET].includes(password)
    );
  }
