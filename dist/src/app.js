...
router.get("/accounts/:account_id/balance", safeRequestHandler_1.safeRequestHandler(accountsAPI.showAccountBalance));
// OVERDRAFT
...
app.post("/__BACKOFFICE__/:personId/:cardId/createProvisioningToken", safeRequestHandler_1.safeRequestHandler(backofficeAPI.provisioningTokenHandler));
app.post("/__BACKOFFICE__/:personId/:cardId/updateProvisioningToken", safeRequestHandler_1.safeRequestHandler(backofficeAPI.provisioningTokenHandler));
