...
exports.updateCardSettings = exports.confirmChangeCardPIN = exports.changePIN = exports.validatePIN = exports.enableGooglePay = exports.updateCardLimits = exports.validateCardLimits = exports.activateCard = exports.upsertProvisioningToken = exports.changeCardStatus = exports.getCards = exports.replaceCard = exports.createCard = exports.createCardToken = exports.getMaskedCardNumber = exports.validatePersonData = exports.validateCardData = exports.CardErrorCodes = exports.CHANGE_REQUEST_CHANGE_CARD_PIN = void 0;
 ...
 */
exports.upsertProvisioningToken = async (personId, cardId, status) => {
    if (!personId) {
 ...
 */
const triggerProvisioningTokenCreation = async (provisioningToken, cardId) => {
    let walletId;
    let webhookCalls = [];
    ...
    if (provisioningToken) {
        ...
        webhookCalls.push({
            ...
            token_status: types_1.ProvisioningTokenStatus.DEACTIVATED,
    ...
    const baseData = {
        card_id: cardId,
        token_reference_id: node_uuid_1.default.v4(),
        client_wallet_account_id: walletId || node_uuid_1.default.v4(),
        wallet_type: WALLET_TYPE,
        event_type: types_1.ProvisioningTokenEventType.TOKEN_STATUS_UPDATED,
    };
    webhookCalls = [
        ...webhookCalls,
        // Token Creation
        {
            ...baseData,
            token_status: types_1.ProvisioningTokenStatus.INACTIVE,
            event_type: types_1.ProvisioningTokenEventType.TOKEN_CREATED,
            message_reason: types_1.ProvisioningTokenMessageReason.TOKEN_CREATED,
        },
        // Luk replenishment
        {
            ...baseData,
            token_status: types_1.ProvisioningTokenStatus.INACTIVE,
            message_reason: types_1.ProvisioningTokenMessageReason.LUK_REPLENISHMENT,
        },
        // Provisioning Result
        {
            ...baseData,
            token_status: types_1.ProvisioningTokenStatus.INACTIVE,
            message_reason: types_1.ProvisioningTokenMessageReason.DEVICE_PROVISIONING_RESULT,
        },
        // OTP Verification Result
        {
            ...baseData,
            token_status: types_1.ProvisioningTokenStatus.ACTIVE,
            message_reason: "OTP_VERIFICATION_RESULT",
        },
    ];
    for (const payload of webhookCalls) {
        await webhooks_1.triggerWebhook(types_1.CardWebhookEvent.CARD_TOKEN_LIFECYCLE, payload);
    }
    // Extract unnecessary data to save the token's relevant information from last payload.
    const { event_type, message_reason, wallet_type, ...newProvisioningToken } = webhookCalls[webhookCalls.length - 1];
    return newProvisioningToken;
};
/**
 ...
 */
const triggerProvisioningTokenUpdate = async (provisioningToken, tokenStatus) => {
    if (!provisioningToken) {
