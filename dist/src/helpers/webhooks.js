...
const WEBHOOK_SECRETS = {
    ...
    [types_1.PersonWebhookEvent.PERSON_CHANGED]: process.env.SOLARIS_PERSON_CHANGED_WEBHOOK_SECRET,
...
exports.triggerWebhook = async (type, payload, extraHeaders = {}) => {
    ...
    if (WEBHOOK_SECRETS[type]) {
        const solarisWebhookSignature = solarisWebhookSignature_1.generateSolarisWebhookSignature(body, WEBHOOK_SECRETS[type]);
        headers = {
            ...headers,
