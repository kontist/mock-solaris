import { Card, CardDetails, CardStatus, MockPerson, CreateCardData, CardLimits, CardLimitType, SolarisAPIErrorData, ChangeRequestStatus, MockChangeRequest, CardSettings, ReplaceCardData, ProvisioningTokenStatus, ProvisioningTokenStatusChangePayload } from "./types";
 ...
 */
export declare const upsertProvisioningToken: (personId: string, cardId: string, status?: ProvisioningTokenStatus) => Promise<ProvisioningTokenStatusChangePayload>;
