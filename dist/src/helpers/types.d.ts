...
export declare enum ProvisioningTokenStatus {
    ACTIVE = "ACTIVE",
    INACTIVE = "INACTIVE",
    DEACTIVATED = "DEACTIVATED",
    SUSPENDED = "SUSPENDED"
}
export declare type ProvisioningTokenStatusChangePayload = {
    card_id: string;
...
export declare enum ProvisioningTokenEventType {
    TOKEN_CREATED = "TOKEN_CREATED",
    TOKEN_STATUS_UPDATED = "TOKEN_STATUS_UPDATED"
}
export declare enum ProvisioningTokenMessageReason {
    TOKEN_CREATED = "TOKEN_CREATED",
